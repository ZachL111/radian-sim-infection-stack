"""Regression checks for the radian-sim-infection-stack casebook."""
...
from casebook.harness import assert_expected, radian_sim_infection_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_sim_infection_stack_summary(), assert_expected())
